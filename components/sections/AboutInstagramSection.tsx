...
const GRID_IMAGES = bradImagePool.slice(0, 6);

export default function AboutFaInstagramSection() {
  return (
    <section className="font-satoshi bg-white px-4 sm:px-7 md:px-12 py-20 md:py-28 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 md:gap-4">
          {GRID_IMAGES.map((src, i) => (
            ...
            >
              <img
                src={src}
                alt={`Brad Carter FaInstagram post ${i + 1}`}
        ...
        >
          Workouts, events, client wins, and daily motivation — all on FaInstagram.
        </motion.p>

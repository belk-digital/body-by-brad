...
export default function FeaturedSection() {
  ...
  return (
    ...
    >
      {/* Hero bento card */}
      <motion.div
        className="grid grid-cols-1 md:grid-cols-[5fr_7fr] gap-4 min-h-[480px] md:min-h-[560px]"
      ...
      >
        ...
        <div className="rounded-2xl overflow-hidden bg-[#E6FF2B] p-8 sm:p-10 md:p-12 flex flex-col justify-between gap-8">
          <div>
            <span className="inline-flex items-center gap-2 bg-zinc-900 rounded-full pl-1 pr-4 py-1 mb-6">
            ...
            <h3 className="text-3xl sm:text-4xl md:text-5xl font-bold uppercase tracking-tight text-zinc-950 leading-[1.05]">
              {t.merchCardTitleL1}
              <br />
              {t.merchCardTitleL2}
            </h3>
            <p className="text-zinc-700 text-sm sm:text-base leading-relaxed mt-4 max-w-xs">
              {t.merchCardDesc}
            </p>
          </div>
        ...
        <div className="rounded-2xl overflow-hidden relative min-h-[340px] md:min-h-0">
          <img

    ...
    <div className="relative w-full font-satoshi overflow-x-hidden bg-white">
      ...
      >
        <div className="grid grid-cols-1 gap-12 md:grid-cols-[42%_58%] md:gap-16">
          ...
          <div className="flex flex-col justify-start">
            ...
            >
              Everything you need to know about this service. Can&apos;t find your answer?{' '}
              <a href="/contact" className="font-semibold underline underline-offset-2 text-black/70 hover:text-black transition-colors">
                Get in touch.
              </a>
            </motion.p>
          </div>
      ...
      >
        <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="mb-2 text-[10px] font-bold uppercase tracking-[0.28em] text-zinc-700">
              Ready to Start?
            </p>
            <h2
